...
void makeDatacard_SBins(double mGl,double mNLSP,TString sigFile,string histname1,string histname){//[1000],char histname[1000]){
  ...
  f[0] = new TFile(sigFile);
    f[1] = new TFile("FullRun2_WGJets_PhoIdloose_phopt40_BL.root");
  f[2] = new TFile("FullRun2_WJetsToLNu_HT_PhoIdloose_phopt40_BL.root");
  f[3] = new TFile("FullRun2_TTJets_PhoIdloose_phopt40_BL.root");
  f[4] = new TFile("FullRun2_TTGJets_inc_PhoIdloose_phopt40_BL.root");
  f[5] = new TFile("FullRun2_ZNuNu_PhoIdloose_phopt40_BL.root");
  f[6] = new TFile("FullRun2_GJets_QCD_PhoIdloose_phopt40_BL.root");
