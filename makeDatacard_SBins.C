...
void makeDatacard_SBins(double mGl,double mNLSP,TString sigFile,char histname1[1000],char histname[1000]){
  ...
  f[1] = new TFile("Out_WGJets_v18.root");
  f[2] = new TFile("Out_WJets_v18.root");
  f[3] = new TFile("Out_TTjets_v18.root");
  f[4] = new TFile("Out_TTGJets_v18.root");
  f[5] = new TFile("Out_ZJets_Gamma_v18.root");
  //f[5] = new TFile("ZGJetsToNuNuG_v17.root");
  //f[6] = new TFile("ZJetsToNuNu_v17.root");
  f[6] = new TFile("Out_GJets_DR_combined_v18.root");
