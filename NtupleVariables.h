...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   /* vector<int>     *Photons_cutBasedIDFall17V2; */
   /* vector<double>  *Photons_mvaValuesIDFall17V2; */
   ...
   TBranch        *b_Photons;   //!
   TBranch        *b_Photons_cutBasedIDFall17V2;
   TBranch        *b_Photons_mvaValuesIDFall17V2; 
...
void NtupleVariables::Init(TTree *tree, string nameData)
{
 ...
 if (!tree) return;
  ...
  fChain->SetMakeClass(1);
   ...
   PDFweights = 0;
   Photons = 0;
   Photons_cutBasedIDFall17V2 = 0;
   Photons_mvaValuesIDFall17V2 = 0;
   ...
   fChain->SetBranchAddress("Photons_cutBasedIDFall17V2", &Photons_cutBasedIDFall17V2, &b_Photons_cutBasedIDFall17V2);
   fChain->SetBranchAddress("Photons_mvaValuesIDFall17V2", &Photons_mvaValuesIDFall17V2, &b_Photons_mvaValuesIDFall17V2);
