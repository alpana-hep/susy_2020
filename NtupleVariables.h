...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxHLTMuonObjects =999;
   static constexpr Int_t kMaxHLTElectronObjects = 999;
   ...
   Int_t           HLTElectronObjects_;
   Float_t         HLTElectronObjects_fCoordinates_fPt[kMaxHLTElectronObjects];   //[HLTElectronObjects_]                                                             
   Float_t         HLTElectronObjects_fCoordinates_fEta[kMaxHLTElectronObjects];   //[HLTElectronObjects_]                                                            
   Float_t         HLTElectronObjects_fCoordinates_fPhi[kMaxHLTElectronObjects];   //[HLTElectronObjects_]                                                            
   Float_t         HLTElectronObjects_fCoordinates_fE[kMaxHLTElectronObjects];   //[HLTElectronObjects_]                             
   ...
   TBranch        *b_HLTElectronObjects_;   //!                                                                                                                       
   TBranch        *b_HLTElectronObjects_fCoordinates_fPt;   //!                                                                                                       
   TBranch        *b_HLTElectronObjects_fCoordinates_fEta;   //!                                                                                                      
   TBranch        *b_HLTElectronObjects_fCoordinates_fPhi;   //!                                                                                                      
   TBranch        *b_HLTElectronObjects_fCoordinates_fE;   //!                        
...
/*       if (!f || !f->IsOpen()) { */
/*          f = new TFile("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Summer20UL16/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8/0_RA2AnalysisTree.root"); */
/*       } */
...
void NtupleVariables::Init(TTree *tree, string nameData)
{
  ...
  //HLTElectronObjects_=0;
   ...
   fChain->SetBranchAddress("HLTElectronObjects", &HLTElectronObjects_, &b_HLTElectronObjects_);
   fChain->SetBranchAddress("HLTElectronObjects.fCoordinates.fPt", HLTElectronObjects_fCoordinates_fPt, &b_HLTElectronObjects_fCoordinates_fPt);
   fChain->SetBranchAddress("HLTElectronObjects.fCoordinates.fEta", HLTElectronObjects_fCoordinates_fEta, &b_HLTElectronObjects_fCoordinates_fEta);
   fChain->SetBranchAddress("HLTElectronObjects.fCoordinates.fPhi", HLTElectronObjects_fCoordinates_fPhi, &b_HLTElectronObjects_fCoordinates_fPhi);
   fChain->SetBranchAddress("HLTElectronObjects.fCoordinates.fE", HLTElectronObjects_fCoordinates_fE, &b_HLTElectronObjects_fCoordinates_fE);
