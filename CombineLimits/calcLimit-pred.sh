...
filesToTransfer="makeDatacard_SBins.C,higgsAnalysis.tar,PredData_FullRun2_Allruns_MET_FakePhoton.root,PredData_FullRun2_Allruns_MET_LostLepton.root,PredData_FullRun2_Allruns_MET_Zinvi.root,FullRun2_GJets_QCD_PhoIdloose_phopt40_BL.root, map_crosssection_SMprocess_v1.txt, map_crosssection_SMprocess.txt, ${anaExe},TMVAClassification_T5bbbbZg_Phopt40_MET200_13variables_200trees_2maxdepth.weights.xml,${xml_file},PredmakeDatacard_SBins.C"
#FullRun2_WGJets_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root, FullRun2_WJetsToLNu_HT_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root, FullRun2_ZNuNu_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root,FullRun2_TTJets_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root,FullRun2_TTGJets_inc_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root,FullRun2_GJets_QCD_PhoIdloose_phopt40_BL_BDTwith13variables_${anaArg}.root ,map_crosssection_SMprocess_v1.txt, map_crosssection_SMprocess.txt, ${anaExe},TMVAClassification_T5bbbbZg_Phopt40_MET200_13variables_200trees_2maxdepth.weights.xml,${xml_file}"
