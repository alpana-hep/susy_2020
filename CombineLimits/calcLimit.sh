...
filesToTransfer="makeDatacard_SBins.C,higgsAnalysis.tar,FullRun2_WGJets_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root, FullRun2_WJetsToLNu_HT_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root, FullRun2_ZNuNu_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root,FullRun2_TTJets_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root,FullRun2_TTGJets_inc_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root,FullRun2_GJets_QCD_PhoIdloose_phopt40_BL_BDTwithT5bbbbZg_7variables.root ,map_crosssection_SMprocess_v1.txt, map_crosssection_SMprocess.txt, ${anaExe},TMVAClassification_BDT_200trees_2maxdepth.weights.xml"
