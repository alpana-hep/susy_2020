...
void PlotLimits::BookHistogram(const char *outFileName) {
  ...
  h2_mGlmNLSP_rUnc = new TH2D("mGlmNLSP_rUnc","x: mass of gluino, y: mass of neutralino, z: unc r-value",100,12.5,3000.5,300,5,3005);
  h2_mGlmNLSP_r_XsecUp = new TH2D("mGlmNLSP_r_XsecUp","x: mass of gluino, y: mass of neutralino, z: r-value with #sigma+#sigma_{up}(fb)",100,12.5,3000.5,300,5,3005);
  h2_mGlmNLSP_r_XsecDn = new TH2D("mGlmNLSP_r_XsecDn","x: mass of gluino, y: mass of neutralino, z: r-value with #sigma-#sigma_{down}(fb)",100,12.5,3000.5,300,5,3005);
