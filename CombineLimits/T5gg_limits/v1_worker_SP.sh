...
echo "root://cmseos.fnal.gov//store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV18/signals/unskimmed_SortedSignalscans/scan/T5bbbbZg/${outName}_${anaArg}_${gluinoMass}_${nlspMass}_unSkimmed.root" 

echo "root://cmseos.fnal.gov//store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV18/signals/unskimmed_SortedSignalscans/scan/T5bbbbZg/${outName}_${anaArg}_${gluinoMass}_${nlspMass}_unSkimmed.root" > runFileList.txt
...
xrdcp -f higgsCombine${outName}_${gluinoMass}_${nlspMass}_${hist}*.root root://cmseos.fnal.gov//store/user/kalpana/Susy_phoMet/limit_rootout/v17_June2024_optimization/${anaArg}/${hist}/
