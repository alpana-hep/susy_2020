...
char* hname2 = new char[200];
  ...
  // }
      //n=2;
  f[0] = new TFile("Summer20UL18_WGJets_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[1] = new TFile("Summer20UL17_WGJets_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[2] = new TFile("Summer20UL16_WGJets_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[3] = new TFile("Summer20UL16APV_WGJets_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[4] = new TFile("Summer20UL18_WJetsToLNu_HT_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[5] = new TFile("Summer20UL17_WJetsToLNu_HT_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[6] = new TFile("Summer20UL16_WJetsToLNu_HT_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[7] = new TFile("Summer20UL16APV_WJetsToLNu_HT_PhoIdloose_phopt100_MET200_ElectronLL.root");
  ...
  f[12] = new TFile("Summer20UL18_TTGJets_inc_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[13] = new TFile("Summer20UL17_TTGJets_inc_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[14] = new TFile("Summer20UL16_TTGJets_inc_PhoIdloose_phopt100_MET200_ElectronLL.root");
  f[15] = new TFile("Summer20UL16APV_TTGJets_inc_PhoIdloose_phopt100_MET200_ElectronLL.root");
 ...
 vector<float> energyy={59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,19.5,19.5,19.5,19.5,19.5,19.5,19.5,36.0,36.0,36.0,36.0,36.0,36.0,36.0};
  ...
  for(int i_file=0; i_file<16;i_file++)
    {      
