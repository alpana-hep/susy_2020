 ...
 for(int i=0;i<baseline.size();i++)
    {
      ...
      h_Sbins_LL_v2[i] = new TH1F(hname_st,"search bins SP:[0b,1b] x [(NJ=2to4),(NJ=2to4),(NJ:5or6),(NJ>=7)]",52,0,52);
