...
public :
  ...
  Double_t pre_evtwt;
  Double_t pre_dPhi_Met_Jet1;
  Double_t pre_dPhi_Met_Jet2;
  Double_t pre_dPhi_Pho_Jet1;
  Double_t pre_dPhi_Pho_Jet2;

  Double_t pre_MET;
  Double_t pre_METPhi;

  Double_t pre_LeadJets1Pt;
  Double_t pre_LeadJets1Eta;
  Double_t pre_LeadJets1Phi;
  Double_t pre_LeadJets1E;
  Double_t pre_LeadJets2Pt;
  Double_t pre_LeadJets2Eta;
  Double_t pre_LeadJets2Phi;
  Double_t pre_LeadJets2E;
...
void NtupleVariables::init_piTree(){
  ...
  skim_tree->Branch("Nentries",&pre_Nentries);
  skim_tree->Branch("NhadJets",&pre_NhadJets);
  skim_tree->Branch("NbJets",&pre_NbJets);
  skim_tree->Branch("Nphotons",&pre_Nphotons);
  skim_tree->Branch("PhoPt",&pre_PhoPt);
  skim_tree->Branch("PhoEta",&pre_PhoEta);
  skim_tree->Branch("PhoPhi",&pre_PhoPhi);
  skim_tree->Branch("PhoE",&pre_PhoE);
  ...
  skim_tree->Branch("dPhi_Met_Jet1",&pre_dPhi_Met_Jet1);
  skim_tree->Branch("dPhi_Met_Jet2",&pre_dPhi_Met_Jet2);
  skim_tree->Branch("dPhi_Pho_Jet1",&pre_dPhi_Pho_Jet1);
  skim_tree->Branch("dPhi_Pho_Jet2",&pre_dPhi_Pho_Jet2);
  skim_tree->Branch("MET", &pre_MET);
skim_tree->Branch("METPhi", &pre_METPhi);
  skim_tree->Branch("LeadJets1Pt",&pre_LeadJets1Pt);
  skim_tree->Branch("LeadJets1Eta",&pre_LeadJets1Eta);
  skim_tree->Branch("LeadJets1Phi",&pre_LeadJets1Phi);
  skim_tree->Branch("LeadJets1E",&pre_LeadJets1E);
  skim_tree->Branch("LeadJets2Pt",&pre_LeadJets2Pt);
  skim_tree->Branch("LeadJets2Eta",&pre_LeadJets2Eta);
  skim_tree->Branch("LeadJets2Phi",&pre_LeadJets2Phi);
  skim_tree->Branch("LeadJets2E",&pre_LeadJets2E);
