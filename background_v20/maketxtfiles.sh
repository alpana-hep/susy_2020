...
for year in  Fall17
do
    xrdfs root://cmseos.fnal.gov/ ls /store/user/lpcsusyphotons/kalpana/SkimsUL_June2023/ | grep skimmed_Summer20UL18_QCD_HT > runList_skimmed_Summer20UL18_QCD_HT_v1.txt
