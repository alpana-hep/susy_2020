...
#/store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Summer20UL17
...
do
    ...
    xrdfs root://cmseos.fnal.gov/ ls ${path} | grep skimmed_Summer20UL18_ST > runList_skimmed_Summer20UL18_ST.txt
    xrdfs root://cmseos.fnal.gov/ ls ${path} | grep skimmed_Summer20UL17_ST >	runList_skimmed_Summer20UL17_ST.txt
    xrdfs root://cmseos.fnal.gov/ ls ${path} | grep skimmed_Summer20UL16_ST >	runList_skimmed_Summer20UL16_ST.txt
    xrdfs root://cmseos.fnal.gov/ ls ${path} | grep skimmed_Summer20UL16APV_ST >	runList_skimmed_Summer20UL16APV_ST.txt
