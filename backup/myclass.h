...
// Thu Aug 20 10:05:53 2020 by ROOT version 6.18/04
// from TTree PreSelection/PreSelection
// found on file: SR_Fall17.TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SR_Fall17.TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SR_Fall17.TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");
      }
