...
void AnalyzeLightBSM::EventLoop(const char *data,const char *inputFileList, const char *sample) {
  ...
  float met=0.0,ht=0.0; int njets=0, btags=0;
  ...
  // reader1->BookMVA( "BDT_200trees_2maxdepth method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_njet_btag_met_HT_Inclusive_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.weights.xml" );
   for (Long64_t jentry=0; jentry<nentries;jentry++)
	...
	wt = Weight*lumiInfb*1000.0;
      ...
      nocut++;
      //float met,njets, btags, ht;
      met = MET;
      njets = NJets;
      btags = BTags;
      ht= HT;
      Double_t mvaValue = getMVArespone(MET,NJets,BTags,HT);// reader1->EvaluateMVA( "BDT method");
      ...
      // reader->AddVariable( "HT", &HT );
       //      reader->
      //      reader->BookMVA( "BDT method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_njet_btag_met_HT_Inclusive_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.weights.xml" );
