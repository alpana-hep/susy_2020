...
//#include "./BDT_training/dataset_bdt_all_Equalweight_pMSSM_njet_btag_met_HT_Inclusive_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.class.C"
...
void AnalyzeLightBSM::EventLoop(const char *data,const char *inputFileList, const char *sample) {
  ...
  float met=0.0,ht=0.0, njets=0, btags=0;
  // BDT with 4 input variable & 200 trees 2 depth
  TMVA::Reader *reader = new TMVA::Reader();
  reader->AddVariable( "MET", &met );
  reader->AddVariable( "NhadJets", &njets );
  reader->AddVariable( "BTags", &btags );
  reader->AddVariable( "ST", &ht );

  reader->BookMVA( "BDT_200trees_2maxdepth method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_njet_btag_met_HT_NominalBasleine_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.weights.xml" );

  //BDT with 4 variables & 100 trees with 2 max depth
  ...
  reader1->AddVariable( "ST", &ht );

  
 reader1->BookMVA( "BDT_100trees_2maxdepth method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_st_met_njetsbtags_NominalBasleine_100trees_2maxdepth/weights/TMVAClassification_BDT_100trees_2maxdepth.weights.xml" );

 //BDT with 7 variables 200 trees, 2 depth
 TMVA::Reader *reader2 = new TMVA::Reader();
 reader2->AddVariable( "MET", &met );
 reader2->AddVariable( "NhadJets", &njets );
 reader2->AddVariable( "BTags", &btags );
 // reader2->AddVariable( "ST", &ht );
 float mt_phomet=0.0,dphi_ph_met=0.0, dphi_metJet=0.0;

 reader2->AddVariable( "mTPhoMET_", &mt_phomet );
 reader2->AddVariable( "dPhi_PhoMET_", &dphi_ph_met);
 reader2->AddVariable( "dPhi_Met_Jet", &dphi_metJet );
 reader2->AddVariable( "ST", &ht );
 reader2->BookMVA( "BDT_200trees_2maxdepth_7variable method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_allvariable_NominalBasleine_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.weights.xml" );

 //BDT with 7 variables & 100 trees, 2 depth

 TMVA::Reader *reader3 = new TMVA::Reader();
 reader3->AddVariable( "MET", &met );
 reader3->AddVariable( "NhadJets", &njets );
 reader3->AddVariable( "BTags", &btags );
 // reader3->AddVariable( "ST", &ht );
 reader3->AddVariable( "mTPhoMET_", &mt_phomet );
 reader3->AddVariable( "dPhi_PhoMET_", &dphi_ph_met);
 reader3->AddVariable( "dPhi_Met_Jet", &dphi_metJet );
 reader3->AddVariable( "ST", &ht );
 reader3->BookMVA( "BDT_100trees_2maxdepth_7variable method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_allvariable_NominalBasleine_100trees_2maxdepth/weights/TMVAClassification_BDT_100trees_2maxdepth.weights.xml" );
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++)
	...
	cout<<"===load tree entry ==="<<endl;
      ...
      if(s_sample.Contains("MCMC_86_7257_1750"))
        ...
        wt = (0.002991*137.19*1000)/nentries; //gluino mass = 1750 GeV                                                                                                      
      else if(s_sample.Contains("MCMC_86_7257_1400"))
        wt = (0.0284*137.19*1000)/nentries; //need to check luminosity                                                                                                      
	...
	wt = Weight*lumiInfb*1000.0;
      //Double_t = outreader->EvaluateMV("BDT method");
    ...
    if (hadJets.size()==0) continue;// cout<<"wrong event"<<endl;
    ...
    btags = BTags;
    mt_phomet= mTPhoMET;
    dphi_ph_met=dPhi_PhoMET;
    //    cout<<"running till reader booking"<<endl;
    dphi_metJet= abs(DeltaPhi(METPhi,(hadJets)[0].Phi()));
    Double_t mvaValue = reader->EvaluateMVA( "BDT_200trees_2maxdepth method");
    Double_t mvaValue1 = reader1->EvaluateMVA( "BDT_100trees_2maxdepth method");
    Double_t mvaValue2 = reader2->EvaluateMVA("BDT_200trees_2maxdepth_7variable method");
    Double_t mvaValue3 = reader3->EvaluateMVA("BDT_100trees_2maxdepth_7variable method");
    ...
    h_mvaResponse_4variable[0]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[0]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[0]->Fill(mvaValue3,wt);
    h_dPhi_MetJet[0]->Fill(dphi_metJet,wt);
    //    cout<<"check1"<<endl;
    if(bestPhoton.Pt()>30) 
    ...
    h_mvaResponse_4variable[1]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[1]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[1]->Fill(mvaValue3,wt);
    h_dPhi_MetJet[1]->Fill(dphi_metJet,wt);
    ...
    h_mvaResponse_4variable[2]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[2]->Fill(mvaValue2,wt);
    h_dPhi_MetJet[2]->Fill(dphi_metJet,wt);
    h_mvaResp_7variable_100tree[2]->Fill(mvaValue3,wt);
    ...
    h_mvaResponse_4variable[3]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[3]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[3]->Fill(mvaValue3,wt);
    h_dPhi_MetJet[3]->Fill(dphi_metJet,wt);
    ...
    h_mvaResponse_4variable[4]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[4]->Fill(mvaValue2,wt);
    h_dPhi_MetJet[4]->Fill(dphi_metJet,wt);
    h_mvaResp_7variable_100tree[4]->Fill(mvaValue3,wt);
    ...
    h_mvaResponse_4variable[5]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[5]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[5]->Fill(mvaValue3,wt);
    h_dPhi_MetJet[5]->Fill(dphi_metJet,wt);
    ...
    //    cout<<"running before met new lorentx vector"<<endl;
    //Met.SetPtEtaPhiE(MET,0,METPhi,0);
    ...
    h_mvaResponse_4variable[6]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[6]->Fill(mvaValue2,wt);
    h_dPhi_MetJet[6]->Fill(dphi_metJet,wt);
    h_mvaResp_7variable_100tree[6]->Fill(mvaValue3,wt);
    ...
    h_mvaResponse_4variable[7]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[7]->Fill(mvaValue2,wt);
    h_dPhi_MetJet[7]->Fill(dphi_metJet,wt);
    h_mvaResp_7variable_100tree[7]->Fill(mvaValue3,wt);
    //ST >300 cut
    if( (ST <= 300) ) continue;
    ...
    h_mvaResponse_4variable[8]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[8]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[8]->Fill(mvaValue3,wt);
    h_dPhi_MetJet[8]->Fill(dphi_metJet,wt);
    ...
    h_dPhi_MetJet[10]->Fill(dphi_metJet,wt);
    h_mvaResponse_4variable[10]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[10]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[10]->Fill(mvaValue3,wt);
    int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
    h_Sbins_v6_withOnlyBL_Selec_Met100->Fill(Sbin,wt);
    ...
    h_dPhi_MetJet[9]->Fill(dphi_metJet,wt);
    h_mvaResponse_4variable[9]->Fill(mvaValue1,wt);
    h_mvaResponse_7variable[9]->Fill(mvaValue2,wt);
    h_mvaResp_7variable_100tree[9]->Fill(mvaValue3,wt);
    ...
    if(mvaValue1 > 0.3){
      ...
      h_dPhi_MetJet[14]->Fill(dphi_metJet,wt);
      h_mvaResponse_4variable[14]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[14]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[14]->Fill(mvaValue3,wt);
      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_HT15TeV_Met100->Fill(Sbin,wt);
    ...
    if(mvaValue > 0.3) {
      ...
      h_dPhi_MetJet[13]->Fill(dphi_metJet,wt);
      h_mvaResponse_4variable[13]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[13]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[13]->Fill(mvaValue3,wt);

      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_HT15TeV_Met250->Fill(Sbin,wt);
    }
    if(mvaValue2 > 0.0){
      ...
      h_dPhi_MetJet[11]->Fill(dphi_metJet,wt);
      h_mvaResponse_4variable[11]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[11]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[11]->Fill(mvaValue3,wt);
      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_PrevAna->Fill(Sbin,wt);
    ...
    if(mvaValue3 >0.0) {
      ...
      h_mvaResponse_4variable[12]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[12]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[12]->Fill(mvaValue3,wt);

      h_dPhi_MetJet[12]->Fill(dphi_metJet,wt);
      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_HT1TeV_Met100->Fill(Sbin,wt);
    }
    ...
    if(mvaValue2 > 0.3){
      ...
      h_dPhi_MetJet[15]->Fill(dphi_metJet,wt);
      h_mvaResponse_4variable[15]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[15]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[15]->Fill(mvaValue3,wt);
      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_HT1TeV_Met250->Fill(Sbin,wt);
    ...
    if(mvaValue3 >0.3) {
      ...
      h_mvaResponse_4variable[16]->Fill(mvaValue1,wt);
      h_mvaResponse_7variable[16]->Fill(mvaValue2,wt);
      h_mvaResp_7variable_100tree[16]->Fill(mvaValue3,wt);

      h_dPhi_MetJet[16]->Fill(dphi_metJet,wt);
      int Sbin=getBinNoV6_WithOnlyBLSelec(BTags,nHadJets);
      h_Sbins_v6_withOnlyBL_Selec_HT1TeV_Met250_Pt100->Fill(Sbin,wt);
    }
...
//   reader1->BookMVA( "BDT_200trees_2maxdepth method", "/home/kalpana/t3store3/public/SUSY_GMSB_Aug_2020/CMSSW_11_1_0_pre3/src/Susy_Analysis_2020/BDT_training/dataset_bdt_all_Equalweight_pMSSM_njet_btag_met_HT_Inclusive_200trees_2maxdepth/weights/TMVAClassification_BDT_200trees_2maxdepth.weights.xml" );
//   met = MET;
//   njets= NJets;
//   btags = BTags;
//   ht = HT;
