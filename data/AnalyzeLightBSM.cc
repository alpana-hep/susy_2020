...
void AnalyzeLightBSM::EventLoop(const char *data,const char *inputFileList, const char *sample , const char *outFileName, const char *elec, const char* phoID) {
  ...
  cout<<cross_section<<"\t"<<"analyzed process"<<"\t"<<s_sample<<endl;
 ...
 //  nentries=100000;
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      else if(s_sample.Contains("WGJets")|| s_sample.Contains("ZNuNuGJets")|| s_sample.Contains("ZJets") ||s_sample.Contains("QCD") || s_sample.Contains("GJets")) //(s_data.Contains("2016") || s_data.Contains("2017") || s_data.Contains("2018") || s_sample.Contains("WGJets"))
	{
      ...
      else if ((s_data.Contains("2016") || s_data.Contains("2017") || s_data.Contains("2018")) && !s_sample.Contains("data"))// || s_sample.Contains("WGJets"))
	{
	  wt = Weight*lumiInfb*1000.0;
	}
      if(s_sample.Contains("data"))
	  	wt =1.0; //cout<<s_sample<<"\t"<<"finalweight"<<"\t"<<wt<<endl;}
      if(jentry==10)
    ...
    genmindr = 0.0;//MinDr(bestPhoton,(*GenJets));
    ...
    if(bestPhoton.Pt()>100)
      h_selectBaselineYields_->Fill("pt>40",wt);
    else continue;
    ...
    double mindr_Pho_genlep=0.0;
    if(!s_sample.Contains("data"))
      {
	mindr_Pho_genlep=getGenLep(bestPhoton);
    ...
    if(Debug)
      cout<<"===load tree entry before after Preselection ==="<<"\t"<<jentry<<endl;
    ...
    if(Debug)
      cout<<"==== different variables mva checks====="<<jentry<<"\t"<<mvaValue<<endl;
    ...
    // else continue;
    //}
    //cout<<(*Photons_nonPrompt).size()<<"\t"<<(*Photons).size()<<endl;
    // if(Debug && (*Photons).size()>0)
    //   {cout<<"check"<<"\t"<<endl;
    //   cout<<"===load tree entry befor prompt/non prompt ==="<<"\t"<<jentry<<"\t"<<(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons)<<"\t"<<(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons)<<"\t"<<"\t"<<bestPhotonIndxAmongPhotons<<endl;
    //   }
    nsurVived+=wt;
    if(!s_sample.Contains("data"))
      {
	if(!(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons) && !(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons) && hasGenPromptPhoton)//(*Photons_genMatched).at(bestPhotonIndxAmongPhotons))          
	  {
	    h_Njets_v1[92]->Fill(nHadJets,wt);
	    h_Nbjets_v1[92]->Fill(BTags,wt);
	    h_MET_v1[92]->Fill(MET,wt);
	    h_PhotonPt_v1[92]->Fill(bestPhoton.Pt(),wt);
	    h_St_v1[92]->Fill(ST,wt);
	    h_NonPrompt_ElectronFake[92]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_ElectronFake[92]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_NonPrompt[92]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
	    h_hasGenPromptPhoton_v2[92]->Fill(hasGenPromptPhoton,wt);
	
	  }
	else if((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
	  {
	    h_Njets_v1[94]->Fill(nHadJets,wt);
	    h_Nbjets_v1[94]->Fill(BTags,wt);
	    h_MET_v1[94]->Fill(MET,wt);
	    h_PhotonPt_v1[94]->Fill(bestPhoton.Pt(),wt);
	    h_St_v1[94]->Fill(ST,wt);
	    h_NonPrompt_ElectronFake[94]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_ElectronFake[94]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_NonPrompt[94]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
	    h_hasGenPromptPhoton_v2[94]->Fill(hasGenPromptPhoton,wt);

	  }
	else if ((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons)==1)
	  {
	    h_Njets_v1[93]->Fill(nHadJets,wt);
	    h_Nbjets_v1[93]->Fill(BTags,wt);
	    h_MET_v1[93]->Fill(MET,wt);
	    h_PhotonPt_v1[93]->Fill(bestPhoton.Pt(),wt);
	    h_St_v1[93]->Fill(ST,wt);
	    h_NonPrompt_ElectronFake[93]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_ElectronFake[93]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	    h_NonPrompt[93]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
	    h_hasGenPromptPhoton_v2[93]->Fill(hasGenPromptPhoton,wt);
	...
	else
	  {
	    if((*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
	      {
		h_Njets_v1[95]->Fill(nHadJets,wt);
		h_Nbjets_v1[95]->Fill(BTags,wt);
		h_MET_v1[95]->Fill(MET,wt);
		h_PhotonPt_v1[95]->Fill(bestPhoton.Pt(),wt);
		h_St_v1[95]->Fill(ST,wt);
		h_NonPrompt_ElectronFake[95]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[95]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_NonPrompt[95]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		h_hasGenPromptPhoton_v2[95]->Fill(hasGenPromptPhoton,wt);

	      }
	    else
	      {
		h_Njets_v1[96]->Fill(nHadJets,wt);
		h_Nbjets_v1[96]->Fill(BTags,wt);
		h_MET_v1[96]->Fill(MET,wt);
		h_PhotonPt_v1[96]->Fill(bestPhoton.Pt(),wt);
		h_St_v1[96]->Fill(ST,wt);
		h_NonPrompt_ElectronFake[96]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[96]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_NonPrompt[96]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		h_hasGenPromptPhoton_v2[96]->Fill(hasGenPromptPhoton,wt);
    ...
    if(Debug)
      cout<<"===load tree entry after prompt/non prompt hist fill ==="<<"\t"<<jentry<<endl;

    h_Njets_v1[97]->Fill(nHadJets,wt);
    h_Nbjets_v1[97]->Fill(BTags,wt);
    h_MET_v1[97]->Fill(MET,wt);
    h_PhotonPt_v1[97]->Fill(bestPhoton.Pt(),wt);
    h_St_v1[97]->Fill(ST,wt);
    if(!s_sample.Contains("data"))
      {
    h_NonPrompt_ElectronFake[97]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
    h_ElectronFake[97]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
    h_NonPrompt[97]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
      }
    h_hasGenPromptPhoton_v2[97]->Fill(hasGenPromptPhoton,wt);
	...
	if(((*Electrons)[i].Pt()>10) && abs((*Electrons)[i].Eta()) < 2.5 && (*Electrons_passIso)[i]==1)
	  {
    ...
    if(Debug && v_recEle.size()==1)      cout<<"entry: "<<"\t"<<jentry<<" "<<nlep<<"\t"<<"reco e size"<<" "<<v_recEle.size()<<" "<<Electrons->size()<<"\t"<<NElectrons<<endl;

    for(int i=0;i<Muons->size();i++)
      {
        if(((*Muons)[i].Pt()>10) && abs((*Muons)[i].Eta()) < 2.5 && nmu_reco<1 && (*Muons_passIso)[i]==1)
          {
   ...
   if(NElectrons!=nelec_reco && (*Electrons).size()==1)
     cout<<"Alps Event"<<"\t"<<jentry<<"\t"<<NElectrons<<"\t"<<nelec_reco<<"\t"<<(*Electrons).size()<<"\t"<<(*Electrons)[0].Pt()<<"\t"<<(*Electrons)[0].Eta()<<"\t"<<(*Electrons_passIso)[0]<<"\t"<<v_genEle2.size()<<endl;
   // else
   //   continue;
   ...
   ///////////////////////////////////////////////////// Electron CR   ///////////////////////////////////////////////////
	...
	st = ST;
	if(Debug)
          cout<<"inside elec -CR"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<endl;
	...
	if(mTElecMET>100) {h_selectBaselineYields_CR->Fill("e-CR: mT<100",wt);continue;}
	else { h_selectBaselineYields_CR->Fill("e-CR:mT>100",wt);}
	//cout<<"Event:  "<<jentry<<"\t"<<
	//updated checks for prompt/no	n prompt checks
	if(Debug)
          cout<<"inside elec -CR- check2"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<endl;
	...
	if(!(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons) && !(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons) && hasGenPromptPhoton)//(*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
	  {
	    ...
	    //checks to understand categories better -> dr(#gamm, e) vs ratio of their photon pT
	    h_mindR_elec_pho[0]->Fill(dr2,wt);
	    h_pTratio_elec_pho[0]->Fill((*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
	    h_mindR_Vs_pTratio_elec_pho[0]->Fill(dr2,(*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
	    if(recojetmindr<0.3)
	      {
	...
	else if((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
	  {
	    ...
	    //checks to understand categories better -> dr(#gamm, e) vs ratio of their photon pT                                                  
            h_mindR_elec_pho[2]->Fill(dr2,wt);
            h_pTratio_elec_pho[2]->Fill((*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
            h_mindR_Vs_pTratio_elec_pho[2]->Fill(dr2,(*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
	  ...
	  {
	    //	    cout<<"Event:  "<<jentry<<"\t"<<(*Photons_cutBasedIDFall17V2).at(bestPhotonIndxAmongPhotons)<<"\t"<<(*Photons_mvaValuesIDFall17V2).at(bestPhotonIndxAmongPhotons)<<"\t"<<endl;
	    ...
	    //checks to understand categories better -> dr(#gamm, e) vs ratio of their photon pT                                                  
            h_mindR_elec_pho[1]->Fill(dr2,wt);
            h_pTratio_elec_pho[1]->Fill((*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
            h_mindR_Vs_pTratio_elec_pho[1]->Fill(dr2,(*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
	...
	else
	  {
		...
		//checks to understand categories better -> dr(#gamm, e) vs ratio of their photon pT                                                  
		h_mindR_elec_pho[3]->Fill(dr2,wt);
		h_pTratio_elec_pho[3]->Fill((*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
		h_mindR_Vs_pTratio_elec_pho[3]->Fill(dr2,(*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
		...
		// cout<<"event:  "<<"\t"<<jentry<<"\t"<<bestPhotonIndxAmongPhotons<<endl;
		// for(int i=0;i<Photons_nonPrompt->size();i++)
		//   {
		//     cout<<jentry<<"\t"<<"promptPhoton:   "<<(*Photons_nonPrompt).at(i)<<"\t"<<(*Photons_genMatched).at(i)<<"\t"<<(*Photons_electronFakes).at(i)<<"\t"<<hasGenPromptPhoton<<endl;                                                                             
		//   }
		...
		//checks to understand categories better -> dr(#gamm, e) vs ratio of their photon pT                                                  
		h_mindR_elec_pho[4]->Fill(dr2,wt);
		h_pTratio_elec_pho[4]->Fill((*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
		h_mindR_Vs_pTratio_elec_pho[4]->Fill(dr2,(*Electrons)[e_index].Pt()/bestPhoton.Pt(),wt);
	...
	if(Debug)
          cout<<"inside elec -CR- after prompt vs non promnpt"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<endl;
	...
	if(Debug)
          cout<<"inside elec -CR- after final hist fill"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<endl;
	...
	if(!s_sample.Contains("data"))
	  {
	    ...
	    //cout<<"inside elec -CR- after final hist fill1"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<endl;
	    ...
	    // double mindr_genElecPho = MinDr(bestPhoton,v_genEle2);
	...
	if(Debug)
	  cout<<"inside elec -CR"<<"\t"<<"events"<<"\t"<<jentry<<"\t"<<Sbin<<"\t"<<h_TF->GetBinContent(Sbin+1)<<"\t"<<nHadJets<<"\t"<<BTags<<"\t"<<MET<<endl;
    ...
    ///////////////////////////////           Electron SR      ///////////////////////////////
    if(lost_elec_flag && nelec_reco ==0 && nmu_reco==0 && !s_sample.Contains("data") )//&& (*Electrons).size()!=0)
      {
	nEvents_Selec[17]+=wt;
	...
	fakeElectron =(proc && (bestPhoton.DeltaR(v_genEle2[0])<0.2 && v_genEle2[0].Pt()/bestPhoton.Pt()<1.2 && v_genEle2[0].Pt()/bestPhoton.Pt()>0.8))||(proc1 && ((bestPhoton.DeltaR(v_genEle2[0])<0.2 && v_genEle2[0].Pt()/bestPhoton.Pt()<1.2 && v_genEle2[0].Pt()/bestPhoton.Pt()>0.8)|| (v_genEle2.size()>1 && (bestPhoton.DeltaR(v_genEle2[1])<0.2 && v_genEle2[1].Pt()/bestPhoton.Pt()<1.2 && v_genEle2[0].Pt()/bestPhoton.Pt()>0.8))));
	
				
	if(!(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons) && !fakeElectron && hasGenPromptPhoton)//(*Photons_genMatched).at(bestPhotonIndxAmongPhotons))          
          {
	    ...
	    // checks to understand the categories better in terms of min dR between photon & electron
	    h_mindR_elec_pho[5]->Fill(bestPhoton.DeltaR(v_genEle2[0]),wt);
	...
	else if(fakeElectron)//bestPhoton.DeltaR(v_genEle2[0])<0.2 && v_genEle2[0].Pt()/bestPhoton.Pt()<1.2 && v_genEle2[0].Pt()/bestPhoton.Pt()>0.8)//(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
      {
	...
	h_mindR_elec_pho[7]->Fill(bestPhoton.DeltaR(v_genEle2[0]),wt);
	h_pTratio_elec_pho[7]->Fill(v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	h_mindR_Vs_pTratio_elec_pho[7]->Fill( bestPhoton.DeltaR(v_genEle2[0]),v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	if(recojetmindr<0.3)
	  {
	...
	h_mindR_elec_pho[6]->Fill(bestPhoton.DeltaR(v_genEle2[0]),wt);
	h_pTratio_elec_pho[6]->Fill(v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	h_mindR_Vs_pTratio_elec_pho[6]->Fill( bestPhoton.DeltaR(v_genEle2[0]),v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	if(recojetmindr<0.3)
	  {
	...
	if((*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
	  {
	    ...
	    h_mindR_elec_pho[8]->Fill(bestPhoton.DeltaR(v_genEle2[0]),wt);
            h_pTratio_elec_pho[8]->Fill(v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
            h_mindR_Vs_pTratio_elec_pho[8]->Fill( bestPhoton.DeltaR(v_genEle2[0]),v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	    if(recojetmindr<0.3)
              {
	...
	else
	  {
	    ...
	    h_mindR_elec_pho[9]->Fill(bestPhoton.DeltaR(v_genEle2[0]),wt);
            h_pTratio_elec_pho[9]->Fill(v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
            h_mindR_Vs_pTratio_elec_pho[9]->Fill( bestPhoton.DeltaR(v_genEle2[0]),v_genEle2[0].Pt()/bestPhoton.Pt(),wt);
	...
	pass_accep_elec=0; fail_accep_elec=0; fail_IdElec=0;
	pass_IdElec=0; Elec_passId=false;
	if((v_genEle2[0].Pt()>10 && abs(v_genEle2[0].Eta())<2.5) || (v_genEle2.size()>1 && v_genEle2[1].Pt()>10 && abs(v_genEle2[1].Eta())<2.5))
          {pass_accep_elec++;
            Elec_passAccep = true;
	    double dR = MinDr((*Electrons)[e_index],v_genEle2);
	    if(dR<0.2){pass_IdElec++; Elec_passId= true;}
	    else {fail_IdElec++; Elec_passId= false;	   
	    }
	  }
	else 
	  {
	...
	{
	  h_Njets_v1[77]->Fill(nHadJets,wt);
	  h_Nbjets_v1[77]->Fill(BTags,wt);
	  h_MET_v1[77]->Fill(MET,wt);
	  h_PhotonPt_v1[77]->Fill(bestPhoton.Pt(),wt);
	  h_St_v1[77]->Fill(ST,wt);
	  h_NonPrompt_ElectronFake[77]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	  h_ElectronFake[77]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
	  h_NonPrompt[77]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
	  h_hasGenPromptPhoton_v2[77]->Fill(hasGenPromptPhoton,wt);
	  h_genPromptPho[77]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
	  h_mindR_genJets[77]->Fill(genmindr,wt);
	  h_mindR_recoJets[77]->Fill(recojetmindr,wt);
	  
	  h_mindR_elec_pho[10]->Fill(bestPhoton.DeltaR((*Muons)[mu_index]),wt);
	  h_pTratio_elec_pho[10]->Fill((*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	  h_mindR_Vs_pTratio_elec_pho[10]->Fill( bestPhoton.DeltaR((*Muons)[mu_index]),(*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);

	}
	else if((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
          {
            h_Njets_v1[79]->Fill(nHadJets,wt);
            h_Nbjets_v1[79]->Fill(BTags,wt);
            h_MET_v1[79]->Fill(MET,wt);
            h_PhotonPt_v1[79]->Fill(bestPhoton.Pt(),wt);
            h_St_v1[79]->Fill(ST,wt);
            h_NonPrompt_ElectronFake[79]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
            h_ElectronFake[79]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
            h_NonPrompt[79]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
            h_hasGenPromptPhoton_v2[79]->Fill(hasGenPromptPhoton,wt);
            h_genPromptPho[79]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);

            h_mindR_genJets[79]->Fill(genmindr,wt);
            h_mindR_recoJets[79]->Fill(recojetmindr,wt);
	    h_mindR_elec_pho[12]->Fill(bestPhoton.DeltaR((*Muons)[mu_index]),wt);
	    h_pTratio_elec_pho[12]->Fill((*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	    h_mindR_Vs_pTratio_elec_pho[12]->Fill( bestPhoton.DeltaR((*Muons)[mu_index]),(*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	  }
	else if((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons)==1)
          {
            h_Njets_v1[78]->Fill(nHadJets,wt);
            h_Nbjets_v1[78]->Fill(BTags,wt);
            h_MET_v1[78]->Fill(MET,wt);
            h_PhotonPt_v1[78]->Fill(bestPhoton.Pt(),wt);
            h_St_v1[78]->Fill(ST,wt);
            h_NonPrompt_ElectronFake[78]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
            h_ElectronFake[78]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
            h_NonPrompt[78]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
            h_hasGenPromptPhoton_v2[78]->Fill(hasGenPromptPhoton,wt);
            h_genPromptPho[78]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);

            h_mindR_genJets[78]->Fill(genmindr,wt);
            h_mindR_recoJets[78]->Fill(recojetmindr,wt);
	    h_mindR_elec_pho[11]->Fill(bestPhoton.DeltaR((*Muons)[mu_index]),wt);
	    h_pTratio_elec_pho[11]->Fill((*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	    h_mindR_Vs_pTratio_elec_pho[11]->Fill( bestPhoton.DeltaR((*Muons)[mu_index]),(*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	  }
	else
	  {
	    if((*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
	      {
		h_Njets_v1[80]->Fill(nHadJets,wt);
		h_Nbjets_v1[80]->Fill(BTags,wt);
                h_MET_v1[80]->Fill(MET,wt);
                h_PhotonPt_v1[80]->Fill(bestPhoton.Pt(),wt);
                h_St_v1[80]->Fill(ST,wt);
                h_NonPrompt_ElectronFake[80]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_ElectronFake[80]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_NonPrompt[80]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
                h_hasGenPromptPhoton_v2[80]->Fill(hasGenPromptPhoton,wt);
                h_genPromptPho[80]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
                h_mindR_genJets[80]->Fill(genmindr,wt);
                h_mindR_recoJets[80]->Fill(recojetmindr,wt);
		h_mindR_elec_pho[13]->Fill(bestPhoton.DeltaR((*Muons)[mu_index]),wt);
		h_pTratio_elec_pho[13]->Fill((*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
		h_mindR_Vs_pTratio_elec_pho[13]->Fill( bestPhoton.DeltaR((*Muons)[mu_index]),(*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	      }
	    else
	      {
		h_Njets_v1[81]->Fill(nHadJets,wt);
		h_Nbjets_v1[81]->Fill(BTags,wt);
                h_MET_v1[81]->Fill(MET,wt);
                h_PhotonPt_v1[81]->Fill(bestPhoton.Pt(),wt);
                h_St_v1[81]->Fill(ST,wt);
                h_NonPrompt_ElectronFake[81]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_ElectronFake[81]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_NonPrompt[81]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
                h_hasGenPromptPhoton_v2[81]->Fill(hasGenPromptPhoton,wt);
                h_genPromptPho[81]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
                h_mindR_genJets[81]->Fill(genmindr,wt);
                h_mindR_recoJets[81]->Fill(recojetmindr,wt);
		h_mindR_elec_pho[14]->Fill(bestPhoton.DeltaR((*Muons)[mu_index]),wt);
		h_pTratio_elec_pho[14]->Fill((*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
		h_mindR_Vs_pTratio_elec_pho[14]->Fill( bestPhoton.DeltaR((*Muons)[mu_index]),(*Muons)[mu_index].Pt()/bestPhoton.Pt(),wt);
	      }
	...
	if(nGenMu1==0 && v_genTau2.size()==1 && nGenEle1==1) continue;
	nEvents_Selec[39]+=wt;
	...
	survived_elecge1+=wt;
	if(Debug)
	  cout<<"entry: "<<jentry<<"\t"<<"gen Muon size" <<"\t"<<v_genMu2.size()<<endl;
	...
	if(fakeElectron!=(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
	  cout<<"entry:  "<<"\t"<<jentry<<"\t"<<fakeElectron<<"\t"<<(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons)<<"\t"<<endl;//bestPhoton.DeltaR(v_genEle2[0])<<"\t"<<v_genEle2[0].Pt()/bestPhoton.Pt()<<"\t"<<proc<<endl;
	if(((s_sample.Contains("WGJets") || s_sample.Contains("WJets"))&& nGentau_had1>0) ||( (s_sample.Contains("TTGJets") || s_sample.Contains("TTJets")) && nGentau_had1>1))
	  {
	    if(!(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons) && !fakeElectron && hasGenPromptPhoton)
              {
                h_Njets_v1[87]->Fill(nHadJets,wt);
                h_Nbjets_v1[87]->Fill(BTags,wt);
                h_MET_v1[87]->Fill(MET,wt);
                h_PhotonPt_v1[87]->Fill(bestPhoton.Pt(),wt);
                h_St_v1[87]->Fill(ST,wt);
                h_NonPrompt_ElectronFake[87]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_ElectronFake[87]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_NonPrompt[87]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
                h_hasGenPromptPhoton_v2[87]->Fill(hasGenPromptPhoton,wt);
                h_genPromptPho[87]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
                h_mindR_genJets[87]->Fill(genmindr,wt);
                h_mindR_recoJets[87]->Fill(recojetmindr,wt);

              }
            else if(fakeElectron)//(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
              {
		h_Njets_v1[89]->Fill(nHadJets,wt);
                h_Nbjets_v1[89]->Fill(BTags,wt);
                h_MET_v1[89]->Fill(MET,wt);
                h_PhotonPt_v1[89]->Fill(bestPhoton.Pt(),wt);
                h_St_v1[89]->Fill(ST,wt);
                h_NonPrompt_ElectronFake[89]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[89]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
                h_NonPrompt[89]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
                h_hasGenPromptPhoton_v2[89]->Fill(hasGenPromptPhoton,wt);
                h_genPromptPho[89]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
                h_mindR_genJets[89]->Fill(genmindr,wt);
                h_mindR_recoJets[89]->Fill(recojetmindr,wt);

	      }
	     else if((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons)==1)
	       {
		 h_Njets_v1[88]->Fill(nHadJets,wt);
		 h_Nbjets_v1[88]->Fill(BTags,wt);
		 h_MET_v1[88]->Fill(MET,wt);
		 h_PhotonPt_v1[88]->Fill(bestPhoton.Pt(),wt);
		 h_St_v1[88]->Fill(ST,wt);
		 h_NonPrompt_ElectronFake[88]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		 h_ElectronFake[88]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		 h_NonPrompt[88]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		 h_hasGenPromptPhoton_v2[88]->Fill(hasGenPromptPhoton,wt);
		 h_genPromptPho[88]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);

		 h_mindR_genJets[88]->Fill(genmindr,wt);
		 h_mindR_recoJets[88]->Fill(recojetmindr,wt);
	       }
		 ...
		 if((*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
		   ...
		   {
		     h_Njets_v1[90]->Fill(nHadJets,wt);
		     h_Nbjets_v1[90]->Fill(BTags,wt);
		     h_MET_v1[90]->Fill(MET,wt);
		     h_PhotonPt_v1[90]->Fill(bestPhoton.Pt(),wt);
		     h_St_v1[90]->Fill(ST,wt);
		     h_NonPrompt_ElectronFake[90]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		     h_ElectronFake[90]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		     h_NonPrompt[90]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		     h_hasGenPromptPhoton_v2[90]->Fill(hasGenPromptPhoton,wt);
		     h_genPromptPho[90]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
		     h_mindR_genJets[90]->Fill(genmindr,wt);
		     h_mindR_recoJets[90]->Fill(recojetmindr,wt);

		   }
		 else
		   {
		     h_Njets_v1[91]->Fill(nHadJets,wt);
		     h_Nbjets_v1[91]->Fill(BTags,wt);
		     h_MET_v1[91]->Fill(MET,wt);
		     h_PhotonPt_v1[91]->Fill(bestPhoton.Pt(),wt);
		     h_St_v1[91]->Fill(ST,wt);
		     h_NonPrompt_ElectronFake[91]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		     h_ElectronFake[91]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		     h_NonPrompt[91]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		     h_hasGenPromptPhoton_v2[91]->Fill(hasGenPromptPhoton,wt);
		     h_genPromptPho[91]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
		     h_mindR_genJets[91]->Fill(genmindr,wt);
		     h_mindR_recoJets[91]->Fill(recojetmindr,wt);
	  ...
	  {
	    //cout<<v_genMu2.size()<<"\t"<<v_genTau2.size()<<"\t"<<v_genEle2.size()<<"\t"<<nGentau_had1<<endl;
	    if(!(*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons) && !fakeElectron && hasGenPromptPhoton)
	      {
		h_Njets_v1[82]->Fill(nHadJets,wt);
		h_Nbjets_v1[82]->Fill(BTags,wt);
		h_MET_v1[82]->Fill(MET,wt);
		h_PhotonPt_v1[82]->Fill(bestPhoton.Pt(),wt);
		h_St_v1[82]->Fill(ST,wt);
		h_NonPrompt_ElectronFake[82]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[82]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_NonPrompt[82]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		h_hasGenPromptPhoton_v2[82]->Fill(hasGenPromptPhoton,wt);
		h_genPromptPho[82]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
		h_mindR_genJets[82]->Fill(genmindr,wt);
		h_mindR_recoJets[82]->Fill(recojetmindr,wt);
		h_mindR_elec_pho[15]->Fill(bestPhoton.DeltaR(v_genMu2[0]),wt);

                h_pTratio_elec_pho[15]->Fill(v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
                h_mindR_Vs_pTratio_elec_pho[15]->Fill( bestPhoton.DeltaR(v_genMu2[0]),v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
	      }
	    else if(fakeElectron)//(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons))
	      {
		h_Njets_v1[84]->Fill(nHadJets,wt);
		h_Nbjets_v1[84]->Fill(BTags,wt);
		h_MET_v1[84]->Fill(MET,wt);
		h_PhotonPt_v1[84]->Fill(bestPhoton.Pt(),wt);
		h_St_v1[84]->Fill(ST,wt);
		h_NonPrompt_ElectronFake[84]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[84]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_NonPrompt[84]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		h_hasGenPromptPhoton_v2[84]->Fill(hasGenPromptPhoton,wt);
		h_genPromptPho[84]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);

		h_mindR_genJets[84]->Fill(genmindr,wt);
		h_mindR_recoJets[84]->Fill(recojetmindr,wt);
		h_mindR_elec_pho[17]->Fill(bestPhoton.DeltaR(v_genMu2[0]),wt);
                h_pTratio_elec_pho[17]->Fill(v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
                h_mindR_Vs_pTratio_elec_pho[17]->Fill( bestPhoton.DeltaR(v_genMu2[0]),v_genMu2[0].Pt()/bestPhoton.Pt(),wt);

	      }
	    else if((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons)==1)
	      {
		h_Njets_v1[83]->Fill(nHadJets,wt);
		h_Nbjets_v1[83]->Fill(BTags,wt);
		h_MET_v1[83]->Fill(MET,wt);
		h_PhotonPt_v1[83]->Fill(bestPhoton.Pt(),wt);
		h_St_v1[83]->Fill(ST,wt);
		h_NonPrompt_ElectronFake[83]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_ElectronFake[83]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		h_NonPrompt[83]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		h_hasGenPromptPhoton_v2[83]->Fill(hasGenPromptPhoton,wt);
		h_genPromptPho[83]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);

		h_mindR_genJets[83]->Fill(genmindr,wt);
		h_mindR_recoJets[83]->Fill(recojetmindr,wt);
		h_mindR_elec_pho[16]->Fill(bestPhoton.DeltaR(v_genMu2[0]),wt);
                h_pTratio_elec_pho[16]->Fill(v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
                h_mindR_Vs_pTratio_elec_pho[16]->Fill( bestPhoton.DeltaR(v_genMu2[0]),v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
		...
		if((*Photons_genMatched).at(bestPhotonIndxAmongPhotons))
		  {
		    h_Njets_v1[85]->Fill(nHadJets,wt);
		    h_Nbjets_v1[85]->Fill(BTags,wt);
		    h_MET_v1[85]->Fill(MET,wt);
		    h_PhotonPt_v1[85]->Fill(bestPhoton.Pt(),wt);
		    h_St_v1[85]->Fill(ST,wt);
		    h_NonPrompt_ElectronFake[85]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		    h_ElectronFake[85]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		    h_NonPrompt[85]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		    h_hasGenPromptPhoton_v2[85]->Fill(hasGenPromptPhoton,wt);
		    h_genPromptPho[85]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
		    h_mindR_genJets[85]->Fill(genmindr,wt);
		    h_mindR_recoJets[85]->Fill(recojetmindr,wt);

		    h_mindR_elec_pho[18]->Fill(bestPhoton.DeltaR(v_genMu2[0]),wt);
		    h_pTratio_elec_pho[18]->Fill(v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
		    h_mindR_Vs_pTratio_elec_pho[18]->Fill( bestPhoton.DeltaR(v_genMu2[0]),v_genMu2[0].Pt()/bestPhoton.Pt(),wt);

		  }
		else
		  {
		    h_Njets_v1[86]->Fill(nHadJets,wt);
		    h_Nbjets_v1[86]->Fill(BTags,wt);
		    h_MET_v1[86]->Fill(MET,wt);
		    h_PhotonPt_v1[86]->Fill(bestPhoton.Pt(),wt);
		    h_St_v1[86]->Fill(ST,wt);
		    h_NonPrompt_ElectronFake[86]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),(*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		    h_ElectronFake[86]->Fill((*Photons_electronFakes).at(bestPhotonIndxAmongPhotons),wt);
		    h_NonPrompt[86]->Fill((*Photons_nonPrompt).at(bestPhotonIndxAmongPhotons),wt);
		    h_hasGenPromptPhoton_v2[86]->Fill(hasGenPromptPhoton,wt);
		    h_genPromptPho[86]->Fill((*Photons_genMatched).at(bestPhotonIndxAmongPhotons),wt);
		    h_mindR_genJets[86]->Fill(genmindr,wt);
		    h_mindR_recoJets[86]->Fill(recojetmindr,wt);
		    h_mindR_elec_pho[19]->Fill(bestPhoton.DeltaR(v_genMu2[0]),wt);
		    h_pTratio_elec_pho[19]->Fill(v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
		    h_mindR_Vs_pTratio_elec_pho[19]->Fill( bestPhoton.DeltaR(v_genMu2[0]),v_genMu2[0].Pt()/bestPhoton.Pt(),wt);
