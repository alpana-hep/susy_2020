...
root -b -q 'SRvsCRStacked_LL_varRatio.C("Results/TFbins_v1",3)'
root -b -q 'SRBins_compare.C("Results/SRBins")'
root -b  -q 'purityFactor_calc.C("Results/purityFactor_Calc/",0)'
root -b -q  'purityFactor_calc.C("Results/purityFactor_Calc/data",1)'
root -b -q 'purityFactor_Plots.C("Results/purityFactor_Calc/overlayPlots",0)'

root -b -q 'TF_varKinem_ratio.C("Results/SRvsCR_KinemVar",0)'
root -b -q 'DataMC_SRvsCR_kinem.C("Results/SF_CR_McvsData",0)'

root -b -q 'SF_CRcompare_DatavsMC.C("Results/data_mcComparisons/SF_withPurity",2,0)'
