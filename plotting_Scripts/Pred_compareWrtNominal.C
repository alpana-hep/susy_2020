...
void CompareNominalSF_system(string pathname, int which_Lept, string string_sys)
{
  ...
  //if(which_Lept==1){
    ...
    legend_texts ={"Pred_{nominal}","Pred_{nominal+sys}"};//Total MC","#beta^{b-tag}_{MC}*Data"};//(tag e,probe #gamma) SR","(tag e, probe e) CR"};//,"#tau-had SR","lost #mu SR","lost e SR","(1l,1#gamma) CR","Failed Iso"};
