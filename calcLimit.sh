...
filesToTransfer="makeDatacard_SBins.C,higgsAnalysis.tar,Out_GJets_DR_combined_v18.root,Out_TTGJets_v18.root,Out_TTjets_v18.root,Out_WGJets_v18.root,Out_WJets_v18.root,Out_ZJets_Gamma_v18.root,${anaExe}"
...
do 
	...
	echo "no"
	jdl_file="condor_${dataSetType}_${anaArg}_${massP[0]}_${massP[1]}_job_HT15_T5qqqqHg.jdl"
	log_prefix="condor_${dataSetType}_${anaArg}_${massP[0]}_${massP[1]}_HT15_job"
