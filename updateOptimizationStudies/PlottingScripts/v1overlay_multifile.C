...
canvas_n1->SetBottomMargin(0.13);
  ...
  legend = new TLegend(0.15,0.745,0.8,0.945);  
 ...
 auto  legend1 = new TLegend(0.15,0.7,0.3,0.65);
  ...
  //  hist.at(i)->GetXaxis()->SetRange(1, hist.at(i)->GetNbinsX() + 1);
    ...
    leg_entry[i] = legend->AddEntry(hist.at(i),legend_texts[i].c_str(),"ep");
...
void v1overlay_multifile(string pathname, string model, string gluino_m)
{
  ...
  baseline = {"No_selection","veto_chargTracks","photon_pT40","MET_100","nJets_2","ST_300","dPhi_cut","overlap_removal","MET_200","MET_300"}; //lepton_veto
  vector <string > varName ={"h_St","h_HT","h_NhadJets","h_NBJets","h_MET","h_PhoPt","h_Photon_Eta","h_Photon_Phi","h_MET_Phi","FR_nbtagBins","h_Mt_phoMET","h_dPhi_phoMet","h_Nphotons","h_dPhi_METLeadJet"};
  vector <string> xlabel = {"Sum of p_{T}^{Jets} & p_{T}^{#gamma} [GeV]","HT[GeV]","N_{jets}","N_{ b-jets}","p_{T}^{miss} [GeV]","p_{T}^{#gamma} [GeV]","#eta^{#gamma}","#phi^{#gamma}","#phi^{MET}","Bin No.","M_{T}^{miss & #gamma} [GeV]","dPhi(#gamma,MET)","N_{#gamma}","d#phi(p_{T}^{miss},lead Jet1)"};

  legend_texts ={"No selection","veto lept+isoTracks","p_{T}^{#gamma} > 40","p_{T}^{miss} [GeV] > 100","N_{jets} #geq 2","Sum of p_{T}^{Jets} & p_{T}^{#gamma} > 300 ","d#phi(p_{T}^{miss},lead Jets) > 0.3 ","Preselection","Preselection + p_{T}^{miss} [GeV] > 200","Preselection + p_{T}^{miss} [GeV] > 300"};
  ...
  vector <int> rebin;
  rebin={4,4,1,1,5,5,4,4,4,1,4,4,1,4};//,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,2,2,4,4,4};
  ...
  vector<double> xmax={2500,2500,20,16,1000,900,5,5,5,3,800,5,5,5};//,5,5,1000,5,5,5,1000,5,5,5,1000,5,5,5,1000,5,5,5,1000,2,400,3,100,800};
  ...
  if(Model.Contains("T5bbbbZg") && Gluino_m.Contains("2200")){
   ...
   legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
 ...
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 50 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 200 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
    ...
    Nlsp_m = {"10","100","400","1000","1500","2000"};
        legend_title={"#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 10 GeV)", "#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 100 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 400 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1000 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1500 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 2000 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1000 GeV)"};
 ...
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1500 GeV","m_{#tilde{#chi}_{1}^{0}} = 2000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
   ...
   else if(Model.Contains("T5bbbbZg") && Gluino_m.Contains("1500")){
    Nlsp_m = {"10","100","400","1000","1500","2000"};
        legend_title={"#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 10 GeV)", "#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 100 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 400 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1000 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1500 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 2000 GeV)","#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 1000 GeV)"};

 legend_title={"#tilde{g} #rightarrow b #bar{b} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G}, m_{#tilde{g}} = 1500 "};
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1500 GeV","m_{#tilde{#chi}_{1}^{0}} = 2000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};

    f[0] = new TFile("out_T5bbbbZg_1500_10.root");
    f[1] = new TFile("out_T5bbbbZg_1500_50.root");
    f[2] = new TFile("out_T5bbbbZg_1500_100.root");
    f[3] = new TFile("out_T5bbbbZg_1500_200.root");
    f[4] = new TFile("out_T5bbbbZg_1500_400.root");
    f[5] = new TFile("out_T5bbbbZg_1500_600.root");
    f[6] = new TFile("out_T5bbbbZg_1500_1000.root");
  }

  else if(Model.Contains("T5qqqqHg") && Gluino_m.Contains("2500")){
    Nlsp_m = {"127","400","1000","1500","2000"};
     n_files=5;
     legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde{#chi}_{1}^{0}} = 127 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde {#chi}_{1}^{0}} = 400 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1500 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde {#chi}_{1}^{0}} = 2000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)"};
 legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G}, m_{#tilde{g}} = 2500 "};
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 127 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1500 GeV","m_{#tilde{#chi}_{1}^{0}} = 2000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};     
    f[0] = new TFile("out_T5qqqqHg_2500_127.root");
    f[1] = new TFile("out_T5qqqqHg_2500_400.root");
    f[2] = new TFile("out_T5qqqqHg_2500_1000.root");
    f[3] = new TFile("out_T5qqqqHg_2500_1500.root");
    f[4] = new TFile("out_T5qqqqHg_2500_2000.root");


  }
  else if(Model.Contains("T5qqqqHg") && Gluino_m.Contains("1500")){
    Nlsp_m = {"127","400","1000","1500","2000"};
     n_files=5;
     legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde{#chi}_{1}^{0}} = 127 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde {#chi}_{1}^{0}} = 400 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} =1500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1500 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde {#chi}_{1}^{0}} = 2000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 1500 GeV, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)"};

 legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G}, m_{#tilde{g}} = 1500 "};
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 127 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1500 GeV","m_{#tilde{#chi}_{1}^{0}} = 2000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};

    f[0] = new TFile("out_T5qqqqHg_1500_127.root");
    // f[1] = new TFile("out_T5qqqqHg_1500_150.root");                                                                                                               
    f[1] = new TFile("out_T5qqqqHg_1500_400.root");
    //f[4] = new TFile("out_T5qqqqHg_1500_600.root");                                                                                                                
    f[2] = new TFile("out_T5qqqqHg_1500_1000.root");
    f[3] = new TFile("out_T5qqqqHg_1500_1500.root");
    f[4] = new TFile("out_T5qqqqHg_1500_2000.root");
  }

  else if(Model.Contains("T5qqqqHg") && Gluino_m.Contains("2200")){
    Nlsp_m = {"127","400","1000","1500","2000"};
     n_files=5;
     legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2200 GeV, m_{#tilde{#c\
hi}_{1}^{0}} = 127 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2200 GeV, m_{#t\
ilde {#chi}_{1}^{0}} = 400 GeV)", "#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} = 2200 Ge\
V, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#tilde{g}} =\
 2200 GeV, m_{#tilde {#chi}_{1}^{0}} = 1500 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} (m_{#til\
de{g}} = 2200 GeV, m_{#tilde {#chi}_{1}^{0}} = 2000 GeV)","#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G} \
(m_{#tilde{g}} = 2200 GeV, m_{#tilde {#chi}_{1}^{0}} = 1000 GeV)"};
 legend_title={"#tilde{g} #rightarrow q #bar{q} #tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/H #tilde{G}, m_{#tilde{g}} = 2200 "};
 legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 127 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1500 \
GeV","m_{#tilde{#chi}_{1}^{0}} = 2000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
    f[0] = new TFile("out_T5qqqqHg_2200_127.root");
    f[1] = new TFile("out_T5qqqqHg_2200_400.root");
    f[2] = new TFile("out_T5qqqqHg_2200_1000.root");
    f[3] = new TFile("out_T5qqqqHg_2200_1500.root");
    f[4] = new TFile("out_T5qqqqHg_2200_2000.root");
 ...
 //  }
    ...
    f[6] = new TFile("out_T5ttttZg_2600_1000.root");    
     ...
     n_files=6;
       ...
       legend_title={"#tilde{t} #rightarrow t#tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{t}} = 1300 ) "};
       legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 50 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 200 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
     ...
     legend_title={"#tilde{t} #rightarrow t#tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{t}} = 1400 ) "};
     legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 50 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 200 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
    ...
    f[5] = new TFile("out_T6ttZg_1400_600.root");
     ...
     legend_title={"#tilde{t} #rightarrow t#tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{t}} = 1600 )"};
     legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 50 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 200 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
   ...
   legend_title={"#tilde{t} #rightarrow t#tilde{#chi}_{1}^{0}, #tilde{#chi}_{1}^{0} #rightarrow #gamma/Z #tilde{G} (m_{#tilde{t}} = 1800) "};
   legend_texts_v1 = {"m_{#tilde{#chi}_{1}^{0}} = 10 GeV","m_{#tilde{#chi}_{1}^{0}} = 50 GeV","m_{#tilde{#chi}_{1}^{0}} = 100 GeV","m_{#tilde{#chi}_{1}^{0}} = 200 GeV","m_{#tilde{#chi}_{1}^{0}} = 400 GeV","m_{#tilde{#chi}_{1}^{0}} = 600 GeV","m_{#tilde{#chi}_{1}^{0}} = 1000 GeV"};
...
int   n_cut =baseline.size();
 ...
 for(int i_cut=n_cut-2; i_cut<n_cut;i_cut++){
   // vector<TH1D*> hist_list_Njets;
   // vector<TH1D*> hist_list_Bjets;
   for(int i_var=0; i_var<n_var;i_var++)
         {
	  ...
	  int xrange=0.0;
	  sprintf(full_path,"%s/%s_%s_%s_%s_overlayPoints",pathname.c_str(),varName[i_var].c_str(),baseline[i_cut].c_str(),model.c_str(),gluino_m.c_str());
