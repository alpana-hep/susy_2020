...
path=/store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Summer20UL16APV #/store/user/lpcsusyphotons/SoftPhoton/kalpana/SkimsUL_June2023
...
for year in  Fall17
do
    xrdfs root://cmseos.fnal.gov/ ls /store/user/lpcsusyphotons/SoftPhoton/kalpana/SkimsUL_June2023/ | grep skimmed_Summer20UL18_QCD_HT > runList_skimmed_Summer20UL18_QCD_HT_v1.txt
