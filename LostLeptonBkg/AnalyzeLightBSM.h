...
class AnalyzeLightBSM : public NtupleVariables{
 ...
 public:
  ...
  TH1F *h_St_CR[60];
  TH1F *h_HT_CR[60];
  TH1F *h_TFbins_ElecLL[60];
  TH1F *h_TFbins_MuonLL[60];
  // Gen level plots
  TH1F *h_Lep_pT;
  TH1F *h_elec_pT;
  TH1F *h_mu_pT;
...
vector<string> baseline = {"Nocut", "PreSelection","Elec_CR","Elec_SR","FailAcep_ElecSR","FailId_ElecSR","FailIso_ElecSR","Mu_CR","Mu_SR","FailAcep_MuSR","FailId_MuSR","FailIso_MuSR","Elec_CR_BDTcut1","Elec_SR_BDTcut1","FailAcep_ElecSR_BDTcut1","FailId_ElecSR_BDTcut1","FailIso_ElecSR_BDTcut1","Mu_CR_BDTcut1","Mu_SR_BDTcut1","FailAcep_MuSR_BDTcut1","FailId_MuSR_BDTcut1","FailIso_MuSR_BDTcut1","Elec_CR_BDTcut2","Elec_SR_BDTcut2","FailAcep_ElecSR_BDTcut2","FailId_ElecSR_BDTcut2","FailIso_ElecSR_BDTcut2","Mu_CR_BDTcut2","Mu_SR_BDTcut2","FailAcep_MuSR_BDTcut2","FailId_MuSR_BDTcut2","FailIso_MuSR_BDTcut2"};
  ...
  h_mindR_genPho_recoPho = new TH1F("h_mindR_genPho_recoPho","dR(Gen-#gamma, Rec-#gamma)",500,0,10);
  h_mindR_recoPho_recoElec = new TH1F("h_mindR_recoPho_recoElec","dR(#gamma, Gen -e^{-})",500,0,10);
  h_mindR_recoPho_genElec = new TH1F("h_mindR_recoPho_genElec","dR(#gamma, Reco-e^{-})",500,0,10);
  h2d_mindRvs_pt_bestPho_genElec = new TH2F("h2d_mindRvs_pt_bestPho_genElec","dR(#gamma, e^{-}) [X-axis], pT_{#gamma}/pT_{e^{-}}",500,0,10,500,0,10);
