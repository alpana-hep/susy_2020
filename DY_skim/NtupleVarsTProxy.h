...
//   (at Sun Jul  9 07:11:19 2023 by ROOT version 6.24/08)
//   from TTree PreSelection/PreSelection
//   found on file: WGJets_MonoPhoton_PtG-40to130_RA2AnalysisTree.root
/////////////////////////////////////////////////////////////////////////
...
//   Set branch addresses
   ...
   if (htemp == 0) {
      ...
      //htemp->SetTitle("macrofilename.cc");
      fObject = htemp;
   }
}

/*
Bool_t NtupleVarsTProxy::Notify()
{
   // Called when loading a new file.
   // Get branch pointers.
   fDirector.SetTree(fChain);
   //macrofilename_Notify();
...
/*
void NtupleVarsTProxy::Begin(TTree *tree)
{
   ...
   //macrofilename_Begin(tree);

}
*/

/*
void NtupleVarsTProxy::SlaveBegin(TTree *tree)
{
   // The SlaveBegin() function is called after the Begin() function.
   // When running with PROOF SlaveBegin() is called on each slave server.
   // The tree argument is deprecated (on PROOF 0 is passed).
  
  std::cout << " NtupleVarsTProxy::SlaveBegin(TTree *tree) tree->GetEntries()" << tree->GetEntries() << std::endl;
  
   Init(tree);

   //macrofilename_SlaveBegin(tree);

}
*/

//inline Bool_t NtupleVarsTProxy::Process(Long64_t entry)
//{
...
//   htemp->Fill(macrofilename());
//   macrofilename_Process(entry);
//   return kTRUE;
//
//}

/*
void NtupleVarsTProxy::SlaveTerminate()
{
   // The SlaveTerminate() function is called after all entries or objects
   // have been processed. When running with PROOF SlaveTerminate() is called
   // on each slave server.
  //macrofilename_SlaveTerminate();
}
*/

/*
void NtupleVarsTProxy::Terminate()
{
