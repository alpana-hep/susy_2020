...
#Add variables and spectators to factory
     ...
     # loader.AddVariable('dPhi_Jet_pho','F')
     # loader.AddVariable('dPhi_PhoMET_','F')
     # loader.AddVariable('dPhi_Met_Jet','F')
     # loader.AddVariable('eta_jet_pho','F')
...
sigcuts = TCut('NJets >=2')
bkgcuts =  TCut('NJets >=2')
...
name = "ROC_%s_%s_%s_%s.png"%(args.sig_name1,args.back_name1,args.back_name2,args.name)#,args.back_name3)
c.Draw()
