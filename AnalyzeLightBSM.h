...
class AnalyzeLightBSM : public NtupleVariables{
 ...
 public:
  ...
  void FillHistogram_Kinematics(int ,TLorentzVector,int, int, double , double, double, double,float,float,double,float,double,double,double,double,double,TLorentzVector,vector<TLorentzVector>,TLorentzVector, int, double, double);
