...
void Baseline_cutflow()//string pathname, int which_Lept, int which_TFBins, bool all)
{
...
char* hname2 = new char[200];
  ...
  f[4] = new TFile("Summer20UL18_WJetsToLNu_HT_PhoIdloose_phopt40_BL.root");
  f[5] = new TFile("Summer20UL17_WJetsToLNu_HT_PhoIdloose_phopt40_BL.root");
  f[6] = new TFile("Summer20UL16_WJetsToLNu_HT_PhoIdloose_phopt40_BL.root");
  f[7] = new TFile("Summer20UL16APV_WJetsToLNu_HT_PhoIdloose_phopt40_BL.root");
  f[8] = new TFile("Summer20UL18_TTJets_PhoIdloose_phopt40_BL.root");
  f[9] = new TFile("Summer20UL17_TTJets_PhoIdloose_phopt40_BL.root");
  f[10] = new TFile("Summer20UL16_TTJets_PhoIdloose_phopt40_BL.root");
  f[11] = new TFile("Summer20UL16APV_TTJets_PhoIdloose_phopt40_BL.root");
  f[12] = new TFile("Summer20UL18_TTGJets_inc_PhoIdloose_phopt40_BL.root");
  f[13] = new TFile("Summer20UL17_TTGJets_inc_PhoIdloose_phopt40_BL.root");
  f[14] = new TFile("Summer20UL16_TTGJets_inc_PhoIdloose_phopt40_BL.root");
  f[15] = new TFile("Summer20UL16APV_TTGJets_inc_PhoIdloose_phopt40_BL.root");
 f[16] = new TFile("Summer20UL18_ZNuNuGJets_PhoIdloose_phopt40_BL.root");
  f[17] = new TFile("Summer20UL17_ZNuNuGJets_PhoIdloose_phopt40_BL.root");
  f[18] = new TFile("Summer20UL16_ZNuNuGJets_PhoIdloose_phopt40_BL.root");
  f[19] = new TFile("Summer20UL16APV_ZNuNuGJets_PhoIdloose_phopt40_BL.root");
   f[20] = new TFile("Summer20UL18_ZJetsToNuNu_HT_PhoIdloose_phopt40_BL.root");
  f[21] = new TFile("Summer20UL17_ZJetsToNuNu_HT_PhoIdloose_phopt40_BL.root");
  f[22] = new TFile("Summer20UL16_ZJetsToNuNu_HT_PhoIdloose_phopt40_BL.root");
  f[23] = new TFile("Summer20UL16APV_ZJetsToNuNu_HT_PhoIdloose_phopt40_BL.root");

   f[24] = new TFile("Summer20UL18_QCD_HT_PhoIdloose_phopt40_BL.root");
  f[25] = new TFile("Summer20UL17_QCD_HT_PhoIdloose_phopt40_BL.root");
  f[26] = new TFile("Summer20UL16_QCD_HT_PhoIdloose_phopt40_BL.root");
  f[27] = new TFile("Summer20UL16APV_QCD_HT_PhoIdloose_phopt40_BL.root");

  
   f[28] = new TFile("Summer20UL18_GJets_DR-0p4_PhoIdloose_phopt40_BL.root");
  f[29] = new TFile("Summer20UL17_GJets_DR-0p4_PhoIdloose_phopt40_BL.root");
  f[30] = new TFile("Summer20UL16_GJets_DR-0p4_PhoIdloose_phopt40_BL.root");
  f[31] = new TFile("Summer20UL16APV_GJets_DR-0p4_PhoIdloose_phopt40_BL.root");  



  
  baseline1 =  {"No_selection","lepton_veto","veto_chargTracks","photon_pT40","MET_100","nJets_2","ST_300","Trig_eff","Event_Cleaning","dPhi_cut","overlap_removal","MET_200"};//,"MET_300","MET_200_phopt_100","MET_300_phopt_100"};//{"No_selection","lepton_veto","veto_chargTracks","photon_pT40","MET_200","nJets_2","ST_300","Trig_eff","Event_Cleaning","dPhi_cut","overlap_removal",};;
 ...
 vector<float> energyy={59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,59.74,41.529,16.5,137.19,19.5,19.5,19.5,19.5,19.5,19.5,19.5,36.0,36.0,36.0,36.0,36.0,36.0,36.0};
  ...
  for(int i_file=0; i_file<32;i_file++)
	...
	{
	  sprintf(hist_name,"h_NBJets_%s",baseline1[i_cut].c_str());
