...
void oneDPred_compareSys(string pathname, int which_Lept, int which_TFBins, bool all, string string_sys)
{
  ...
  baseline1 = {"Elec_CR","Pho_SR","Elec_SR","Mu_SR","TauHad_SR"};//,"Mu_SR","Elec_SR"};
  ...
  if(which_Lept==3){
      baseline1 = {"newSbins_Validation_v7_Elec_CR","v4_newSbins_Validation_v7_Mu_CR","newSbins_v7_TauHad_SR","newSbins_v7_Mu_SR","newSbins_v7_Elec_SR"};
  ...
  if(which_TFBins==1) // btagSFup
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loosebtagSFup_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
  if(which_TFBins==2) // btagSFdown
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loosebtagSFdown_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
  if(which_TFBins==3)                                                                                                                                     
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_looseJetSys_JECup_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
  if(which_TFBins==4)                                                                                         
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_looseJetSys_JECdown_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
   if(which_TFBins==5)
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_looseJetSys_JERup_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
  if(which_TFBins==6)
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_looseJetSys_JERdown_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }

   if(which_TFBins==7)
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loosepuSysUp_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
  if(which_TFBins==8)
    {
      f[0] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loosepuSysDown_pt40_MET200.root");
      f[1] = new TFile("out_Data_FullRun2_Allruns_MET_phoID_loose_pt40_MET200.root");
    }
