...
void plotKinStack_1(){
  ...
  double xMin=0.0,xMax = 800;
       TString varName = "h_St_ST_300"; TString xLabel = "Sum of P_{T}^{Jets} & P_{T}^{#gamma} (GeV)";   int rebin=4; yMin=0.001,yMax = 10000000; xMin=300.0,xMax = 2000;
  // TString varName = "METvBin2_nj2to4_nbjetnot0"; TString xLabel = "p_{T}^{miss} (GeV)";   int rebin=1; yMin=0.005,yMax = 15000; xMin=200.0,xMax = 1000;
       //        TString varName = "h_MET_ST_300"; TString xLabel = "p_{T}^{miss} (GeV)";   int rebin=4; yMin=0.001,yMax = 10000000; xMin=100.0,xMax = 1000;
  // TString varName = "h_Mt_phoMET_ST_300";TString xLabel = "M_{T}^{miss & #gamma} (GeV)"; int rebin=4; yMin=0.001,yMax = 100000000; xMin=0.0,xMax = 700;
  //     TString varName = "h_PhoPt_ST_300"; TString xLabel = "p_{T}^{#gamma} (GeV)";   int rebin=1; yMin=0.001,yMax = 10000000; xMin=30.0,xMax = 300;
  // TString varName = "PhovBin2"; TString xLabel = "p_{T}^{#gamma} (GeV)";   int rebin=1; yMin=0.4,yMax = 1000000; xMin=0.0,xMax = 1200;
  //      TString varName = "h_NhadJets_ST_300"; TString xLabel = "N_{ jets}";   int rebin=1; yMin=0.001,yMax = 100000000; xMin=2.0,xMax = 16;
   // TString varName = "nJets"; TString xLabel = "N_{ jets}";   int rebin=1; yMin=0.1,yMax = 100000; xMin=1,xMax = 14;
  //           TString varName = "h_NBJets_ST_300"; TString xLabel = "N_{ b-jets}";   int rebin=1; yMin=0.001,yMax = 100000000; xMin=1.0,xMax = 8;
  ...
  //TString varName = "h_Sbins_v6_withOnlyBL_Selec_Met100"; TString xLabel = "Bin no.";   int rebin=1; yMin=0.001,yMax = 100000000; xMin=0,xMax = 39;
  ...
  col={kGray,kTeal+9,kOrange,kRed,kCyan-1,kCyan,kBlue,kMagenta,kBlack,kPink+4,kGreen+2,kOrange+1,kBlue+2};
   f[0] = new TFile("BDT_training/Out_TTGJets_v18.root");
     f[1] = new TFile("BDT_training/Out_TTjets_v18.root");
     //f[1]= new TFile("BDT_training/Out_TTJets.root");
   f[2]= new TFile("BDT_training/Out_ZJets_Gamma_v18.root");
  f[5] = new TFile("BDT_training/Out_GJets_DR_combined_v18.root");
  f[3] = new TFile("BDT_training/Out_WGJets_v18.root");
  f[4] = new TFile("BDT_training/Out_WJets_v18.root");
  // f[6] = new TFile("BDT_training/Out_T5bbbbZG_2350_10_Sbin_EventYield.root");
  // f[7] = new TFile("BDT_training/Out_T5bbbbZG_2350_50_Sbin_EventYield.root");
  // f[8] = new TFile("BDT_training/Out_T5bbbbZG_2350_200_Sbin_EventYield.root");
  // f[9] = new TFile("BDT_training/Out_T5bbbbZG_2350_1500_Sbin_EventYield.root");
 // f[6] = new TFile("BDT_training/Out_pMSSM_MCMC_86_7257.root");
 //  f[7] = new TFile("BDT_training/Out_pMSSM_MCMC_70_90438.root");
 //  f[8] = new TFile("BDT_training/Out_pMSSM_MCMC_106_19786.root");
 //  f[9] = new TFile("BDT_training/Out_pMSSM_MCMC_473_54451.root");
  f[6] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1400.root");
  f[7] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1500.root");
  f[8] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1600.root");
  f[9] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1700.root");
  f[10] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1800.root");
  f[11] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg1900.root");
  f[12] = new TFile("BDT_training/out_pMSSM_MCMC_86_7257_Mg2000.root");
...
void drawlegend(TH1D *hist,int i,const char* fname){
  ...
  // else if(lName.Contains("T5bbbbZg_1600_1550")){lName = "T5bbbbZG (m_{#tilde{g}} = 1600 GeV, m_{#tilde{#chi}_{1}^{0}} = 1550 GeV)";}
    ...
    else if(lName.Contains("pMSSM_MCMC_86_7257_Mg1800")){ lName = "pMSSM_86_7257_mg1800";}
  else if(lName.Contains("pMSSM_MCMC_86_7257_Mg1900")){ lName = "pMSSM_86_7257_mg1900";}
else if(lName.Contains("pMSSM_MCMC_86_7257_Mg2000")){ lName = "pMSSM_86_7257_mg2000";}
  else if(lName.Contains("pMSSM_MCMC_86_7257_1750")){ lName = "pMSSM_86_7257_mg1750";}
