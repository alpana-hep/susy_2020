...
class AnalyzeLightBSM : public NtupleVariables{
 ...
 public:
  AnalyzeLightBSM(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data", const char *sample="sample", const char* LostlepFlag ="Flag");
  ~AnalyzeLightBSM();
  ...
  TH1D *h_Nbjets_v1[80];
  TH1F *h_MET_v1[80];
  TH1F *h_PhotonPt_v1[80];
  TH1F *h_St_v1[80];
  TH1F *h_count_v1[80];
  TH2F *h_NonPrompt_ElectronFake[80];
  TH1F *h_NonPrompt[80];
  TH1F *h_ElectronFake[80];
  TH1F *h_hasGenPromptPhoton_v2[80];
  TH2F *h2d_mindRvspT_bestPho_genlep_v1[80];
  TH2F *h2d_mindRvspT_bestPho_genlep_v2[80];
  TH1F *h_ratio_bestPho_genlep_v1[80];
  TH1F *h_ratio_bestPho_genlep_v2[80];
  TH1F *h_hasGenPromptPhoton_v1[60];
  TH1F *h_genPromptPho[80];
  //  TH1F *h_
  TH1F *h_mindR_genJets[80];
  TH1F *h_mindR_recoJets[80];
  TH1F *h_Jets_chargedEmEnergyFraction[80];
  TH1F *h_Jets_chargedHadronEnergyFraction[80];
  TH1F *h_Jets_photonEnergyFraction[80];
  TH1F *h_Jets_photonMultiplicity[80];
  TH1F *h_Jets_neutralEmEnergyFraction[80];
  TH1F *h_Jets_neutralHadronEnergyFraction[80];
 TH2F *h_mindR_recoJetsVs_chargedEmEnergyFraction[80];
 TH1F *h_Jets_chargedEmEnergyFraction_v1[80];
 TH1F *h_Jets_chargedHadronEnergyFraction_v1[80];
 TH1F *h_Jets_photonEnergyFraction_v1[80];
 TH1F *h_Jets_photonMultiplicity_v1[80];
 TH1F *h_Jets_neutralEmEnergyFraction_v1[80];
 TH1F *h_Jets_neutralHadronEnergyFraction_v1[80];

  TH1F *h_St_CR[80];
  TH1F *h_HT_CR[80];
  TH1F *h_mindr_Pho_genlep[80];
  TH1F *h_mindr_Pho_genElec[80];
  TH1F *h_mindr_Pho_RecoEle[80];
  TH1F *h_TFbins_ElecLL[80];
  TH1F *h_TFbins_MuonLL[80];
  TH1F *h_TFbins_ElecLL_v1[80];
  TH1F *h_TFbins_ElecLL_v2[80];
  TH1F *h_Sbins_LL_Validation[80];
  TH1F *h_Sbins_LL[80];
  TH1F *h_TFbins_ElecLL_validation[80];
  TH1F *h_TFbins_ElecLL_validation_v1[80];
  TH1F *h_TFbins_ElecLL_validation_v2[80];
  // Gen level plots
  TH1F *h_Lep_pT;
  TH1F *h_elec_pT;
  TH1F *h_mu_pT;
...
AnalyzeLightBSM::AnalyzeLightBSM(const TString &inputFileList, const char *outFileName, const char* dataset, const char* N2_mass, const char* LostlepFlag) {
