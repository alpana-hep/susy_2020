...
void AnalyzeTProxytBSM::EventLoop(const char *data, const char *sample) {
  ...
  //for (Long64_t jentry=0; jentry<10;jentry++) {
   ...
   bool hasEMobj_pho=false, hasEMobj_pho_px=false,hasEMobj_elec=false;                                    
   ...
   bool Elec_passEtacut=false,Elec_passpTcut=false,Elec_passAccep = false,Elec_failAccep= false, Elec_passId= false, Elec_failId= false,Elec_passIso = false,Elec_failIso = false, genElec_passEtacut=f\
     alse,genElec_passpTcut=false,genElec_passAccep = false, genElec_passId= false, genElec_passIso = false,genMu_passEtacut=false,genMu_passpTcut=false,genMu_passAccep = false, genMu_passId= false, genMu_pa\
     ssIso = false;
